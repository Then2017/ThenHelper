...
package com.google.android.mms.pdu2;

import com.ckt.utils.L;
import com.google.android.mms.pdu2.EncodedStringValue;
import com.google.android.mms2.ContentType;
import com.google.android.mms2.InvalidHeaderValueException;
...
public class PduParser {
    ...
    public GenericPdu parse(){
        if (mPduDataStream == null) {
            L.d(LOG_TAG+ "Input parse stream is null");
            return null;
        }
        ...
        if (null == mHeaders) {
            ...
            L.d(LOG_TAG+ "Parse PduHeader Failed");
            return null;
        }
        ...
        if (PduHeaders.MESSAGE_TYPE_RETRIEVE_CONF == messageType && count >= TEXT_MIN) {
            ...
            if (null == contentType) {
                L.d(LOG_TAG+ "Parse MESSAGE_TYPE_RETRIEVE_CONF Failed: content Type is null _0");
                return null;
            }
            ...
            if (!contentTypeStr.equals(ContentType.MULTIPART_MIXED)
                ...
                if (contentTypeStr.equals(ContentType.TEXT_PLAIN)) {
                    L.d(LOG_TAG+ "Content Type is text/plain");
                    ...
                    try {
                        ...
                        L.d(LOG_TAG+ "new RetrieveConf has exception");
                    }
                    if (retrieveConf == null) {
                        L.d(LOG_TAG+ "retrieveConf is null");
                    }
                    return retrieveConf;
                }
        ...
        if ((PduHeaders.MESSAGE_TYPE_SEND_REQ == messageType) ||
            ...
            if (null == mBody) {
                // Parse parts failed.
                L.d(LOG_TAG+ "Parse parts Failed");
                return null;
            }
        }
        ...
        switch (messageType) {
            ...
            case PduHeaders.MESSAGE_TYPE_RETRIEVE_CONF:
                ...
                if (null == contentType) {
                    L.d(LOG_TAG+ "Parse MESSAGE_TYPE_RETRIEVE_CONF Failed: content Type is null _1");
                    return null;
                }
                ...
                L.d(LOG_TAG+ "Parse MESSAGE_TYPE_RETRIEVE_CONF Failed: content Type is null _2");
                return null;
    ...
    public GenericPdu parseByType(boolean isSend){
      if (mPduDataStream == null) {
          L.d(LOG_TAG+ "Input parse stream is null");
          return null;
      }
...
//        mHeaders.setOctet(PduHeaders.MESSAGE_TYPE, messageType);
      }*/
   /*   try {
        mHeaders.setOctet(messageType,PduHeaders.MESSAGE_TYPE);
                ...
                case PduHeaders.MESSAGE_TYPE:
                {
                    ...
                    switch (messageType) {
                        ...
                        case PduHeaders.MESSAGE_TYPE_CANCEL_CONF:
                            L.d(LOG_TAG+ "PduParser: parseHeaders: We don't support these kind of messages now.");
                            return null;
                    }
                    try {
    ...
    protected static PduBody parseParts(ByteArrayInputStream pduDataStream) {
        ...
        for (int i = 0 ; i < count ; i++) {
            ...
            if (startPos <= 0) {
                // Invalid part.
                L.d(LOG_TAG+ "PduParser: parseParts: Invalid part.");
                return null;
            }
            ...
            if (partHeaderLen > 0) {
                if (false == parsePartHeaders(pduDataStream, part, partHeaderLen)) {
                    ...
                    L.d(LOG_TAG+ "PduParser: parseParts: Parse part header faild.");
                    return null;
                }
            } else if (partHeaderLen < 0) {
                // Invalid length of content-type.
                L.d(LOG_TAG+ "PduParser: parseParts: Invalid length of content-type");
                return null;
            }
            ...
            if ((null == part.getContentLocation())
                ...
                L.d(LOG_TAG+ "PduParser: parseParts: Hasn't find ContentLocation,so generate one.");
                ...
                case PduPart.P_CHARSET:
                    ...
                    if (((firstValue > TEXT_MIN) && (firstValue < TEXT_MAX)) ||
                        ...
                        try {
                            ...
                            L.d(LOG_TAG+ "Parse CharacterSets: charsetStr");
                        ...
                        if (map != null) {
                            L.d(LOG_TAG+ "Parse Well-known-charset: charset");
    ...
    protected static boolean parsePartHeaders(ByteArrayInputStream pduDataStream,
        ...
        while(0 < lastLen) {
            ...
            if (header > TEXT_MAX) {
                ...
                L.d(LOG_TAG+ "Got unknown header field: " + unAssignedHeader);

                if (tempValue != null) {
                    L.d(LOG_TAG+ "Got unknown header tempValue: " + new String(tempValue));
                } else {
                    L.d(LOG_TAG+ "tempValue is null ");
                }
    ...
    protected static boolean checkMandatoryHeader(PduHeaders headers) {
        ...
        if (0 == mmsVersion) {
            ...
            L.d(LOG_TAG+ "Parse MandatoryHeader Failed: PDU hasn't mmsVersion");
            return false;
        }
        ...
        switch (messageType) {
            case PduHeaders.MESSAGE_TYPE_SEND_REQ:
                ...
                if (null == srContentType) {
                    L.d(LOG_TAG+ "Parse MandatoryHeader Failed: MESSAGE_TYPE_SEND_REQ PDU hasn't content type field");
                    return false;
                }
                ...
                if (null == srFrom) {
                    L.d(LOG_TAG+ "Parse MandatoryHeader Failed: MESSAGE_TYPE_SEND_REQ PDU hasn't From field");
                    return false;
                }
                ...
                if (null == srTransactionId) {
                    L.d(LOG_TAG+ "Parse MandatoryHeader Failed: MESSAGE_TYPE_SEND_REQ PDU hasn't Transaction-Id field");
                    return false;
                }
*/
                break;
            case PduHeaders.MESSAGE_TYPE_SEND_CONF:
                ...
                if (0 == scResponseStatus) {
                    L.d(LOG_TAG+ "Parse MandatoryHeader Failed: MESSAGE_TYPE_SEND_CONF PDU hasn't Response-Status field");
                    return false;
                }
                ...
                if (null == scTransactionId) {
                    L.d(LOG_TAG+ "Parse MandatoryHeader Failed: MESSAGE_TYPE_SEND_CONF PDU hasn't Transaction-Id field");
                    return false;
                }
            ...
            case PduHeaders.MESSAGE_TYPE_NOTIFICATION_IND:
                ...
                if (null == niContentLocation) {
                    L.d(LOG_TAG+ "Parse MandatoryHeader Failed: MESSAGE_TYPE_NOTIFICATION_IND PDU hasn't Content-Location field");
                    return false;
                }
                ...
                if (-1 == niExpiry) {
                    L.d(LOG_TAG+ "Parse MandatoryHeader Failed: MESSAGE_TYPE_NOTIFICATION_IND PDU hasn't Expiry field");
                    return false;
                }
                ...
                if (null == niMessageClass) {
                    L.d(LOG_TAG+ "Parse MandatoryHeader Failed: MESSAGE_TYPE_NOTIFICATION_IND PDU hasn't Message-Class field");
                    return false;
                }
                ...
                if (-1 == niMessageSize) {
                    L.d(LOG_TAG+ "Parse MandatoryHeader Failed: MESSAGE_TYPE_NOTIFICATION_IND PDU hasn't Message-Size field");
                    return false;
                }
                ...
                if (null == niTransactionId) {
                    L.d(LOG_TAG+ "Parse MandatoryHeader Failed: MESSAGE_TYPE_NOTIFICATION_IND PDU hasn't Transaction-Id field");
                    return false;
                }
            ...
            case PduHeaders.MESSAGE_TYPE_NOTIFYRESP_IND:
                ...
                if (0 == nriStatus) {
                    L.d(LOG_TAG+ "Parse MandatoryHeader Failed: MESSAGE_TYPE_NOTIFYRESP_IND PDU hasn't Status field");
                    return false;
                }
                ...
                if (null == nriTransactionId) {
                    L.d(LOG_TAG+ "Parse MandatoryHeader Failed: MESSAGE_TYPE_NOTIFYRESP_IND PDU hasn't Transaction-Id field");
                    return false;
                }
            ...
            case PduHeaders.MESSAGE_TYPE_RETRIEVE_CONF:
                ...
                if (null == rcContentType) {
                    L.d(LOG_TAG+ "Parse MandatoryHeader Failed: MESSAGE_TYPE_RETRIEVE_CONF PDU hasn't Content-Type field");
                    return false;
                }
                ...
                if (-1 == rcDate) {
                    L.d(LOG_TAG+ "Parse MandatoryHeader Failed: MESSAGE_TYPE_RETRIEVE_CONF PDU hasn't Date field");
                    return false;
                }
            ...
            case PduHeaders.MESSAGE_TYPE_DELIVERY_IND:
                ...
                if (-1 == diDate) {
                    L.d(LOG_TAG+ "Parse MandatoryHeader Failed: MESSAGE_TYPE_DELIVERY_IND PDU hasn't Date field");
                    return false;
                }
                ...
                if (null == diMessageId) {
                    L.d(LOG_TAG+ "Parse MandatoryHeader Failed: MESSAGE_TYPE_DELIVERY_IND PDU hasn't Message-Id field");
                    return false;
                }
                ...
                if (0 == diStatus) {
                    L.d(LOG_TAG+ "Parse MandatoryHeader Failed: MESSAGE_TYPE_DELIVERY_IND PDU hasn't Status field");
                    return false;
                }
                ...
                if (null == diTo) {
                    L.d(LOG_TAG+ "Parse MandatoryHeader Failed: MESSAGE_TYPE_DELIVERY_IND PDU hasn't To field");
                    return false;
                }
            ...
            case PduHeaders.MESSAGE_TYPE_ACKNOWLEDGE_IND:
                ...
                if (null == aiTransactionId) {
                    L.d(LOG_TAG+ "Parse MandatoryHeader Failed: MESSAGE_TYPE_ACKNOWLEDGE_IND PDU hasn't Transaction-Id field");
                    return false;
                }
            ...
            case PduHeaders.MESSAGE_TYPE_READ_ORIG_IND:
                ...
                if (-1 == roDate) {
                    L.d(LOG_TAG+ "Parse MandatoryHeader Failed: MESSAGE_TYPE_READ_ORIG_IND PDU hasn't Date field");
                    return false;
                }
                ...
                if (null == roFrom) {
                    L.d(LOG_TAG+ "Parse MandatoryHeader Failed: MESSAGE_TYPE_READ_ORIG_IND PDU hasn't From field");
                    return false;
                }
                ...
                if (null == roMessageId) {
                    L.d(LOG_TAG+ "Parse MandatoryHeader Failed: MESSAGE_TYPE_READ_ORIG_IND PDU hasn't Message-Id field");
                    return false;
                }
                ...
                if (0 == roReadStatus) {
                    L.d(LOG_TAG+ "Parse MandatoryHeader Failed: MESSAGE_TYPE_READ_ORIG_IND PDU hasn't Read-Status field");
                    return false;
                }
                ...
                if (null == roTo) {
                    L.d(LOG_TAG+ "Parse MandatoryHeader Failed: MESSAGE_TYPE_READ_ORIG_IND PDU hasn't To field");
                    return false;
                }
            ...
            case PduHeaders.MESSAGE_TYPE_READ_REC_IND:
                ...
                if (null == rrFrom) {
                    L.d(LOG_TAG+ "Parse MandatoryHeader Failed: MESSAGE_TYPE_READ_REC_IND PDU hasn't From field");
                    return false;
                }
                ...
                if (null == rrMessageId) {
                    L.d(LOG_TAG+ "Parse MandatoryHeader Failed: MESSAGE_TYPE_READ_REC_IND PDU hasn't Message-Id field");
                    return false;
                }
                ...
                if (0 == rrReadStatus) {
                    L.d(LOG_TAG+ "Parse MandatoryHeader Failed: MESSAGE_TYPE_READ_REC_IND PDU hasn't Read-Status field");
                    return false;
                }
                ...
                if (null == rrTo) {
                    L.d(LOG_TAG+ "Parse MandatoryHeader Failed: MESSAGE_TYPE_READ_REC_IND PDU hasn't To field");
                    return false;
                }
            ...
            default:
                ...
                L.d(LOG_TAG+ "Parse MandatoryHeader Failed: Parser doesn't support this message type in this version");
                return false;
        }
