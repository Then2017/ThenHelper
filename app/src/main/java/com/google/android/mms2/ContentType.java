...
package com.google.android.mms2;
...
public class ContentType {
    ...
    /// M:Code analyze 001,add new content type,google default code don't support @{
    ...
    /// @}
    /// M:Code analyze 002,add a new Restricted content set corresponding to Support content set @{
    private static final ArrayList<String> sRestrictedContentTypes = new ArrayList<String>();
    /// @}

    static {
        /// M:Code analyze 003,add a TEXT type into support content set @{
        sSupportedContentTypes.add(TEXT_TS);
        /// @}
        /// M:Code analyze 004,add a IMAGE type into support content set @{
        sSupportedContentTypes.add(IMAGE_BMP);
        sSupportedContentTypes.add(IMAGE_XBMP);
        /// @}
        /// M:Code analyze 005,add AUDIO type into support content set @{
        ...
        /// @}
        /// M:Code analyze 006,add a VIDEO type into support content set @{
        ...
        /// @}
        /// M:Code analyze 008,add IMAGE type into support Image set @{
        sSupportedImageTypes.add(IMAGE_BMP);
        sSupportedImageTypes.add(IMAGE_XBMP);
        /// @}
        /// M:Code analyze 009,add audio type into support video set @{
        ...
        /// @}
        /// M:Code analyze 010,add video and text type into support video set @{
        sSupportedVideoTypes.add(VIDEO_TS);
        sSupportedVideoTypes.add(TEXT_TS);
        /// @}
    }
    /// M:Code analyze 011,add a new method for judging if it is restricted content type @{
